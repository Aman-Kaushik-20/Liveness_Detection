...
model = YOLO(r"C:\Users\Aman\Desktop\DeepFace Liveness\best_liveness98epoch.pt")
 
classNames = [ "Fake","Real"]
# classNames = ["Real person","Spoof Of Real Person" "bicycle", "car", "motorbike", "aeroplane", "bus", "train", "truck", "boat",
